    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          ...
          <li class="breadcrumb-item active">{{trans('lang.deliverycharge_edit')}}</li>
        </ol>
      </div><!-- /.col -->
    </div><!-- /.row -->
  </div><!-- /.container-fluid -->
  ...
  <div class="card">
    <div class="card-header">
      <ul class="nav nav-tabs align-items-end card-header-tabs w-100">
        ...
        <!-- @endcan -->
        <li class="nav-item">
          <a class="nav-link active" href="{!! url()->current() !!}"><i class="fa fa-pencil mr-2"></i>{{trans('lang.edit_delivery_charge')}}</a>
        </li>
      </ul>
    </div>
    <div class="card-body">
      {!! Form::model($charge, ['url' => ['Delivery_Charge/update', $charge->id], 'method' => 'post']) !!}
      <div class="row">
